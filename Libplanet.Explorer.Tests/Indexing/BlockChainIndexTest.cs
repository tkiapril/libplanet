...
public abstract class BlockChainIndexTest
{
    ...
    public async Task Synchronize()
    {
        ...
        var index2 = Fx.CreateEphemeralIndexInstance();

        // ReSharper disable once MethodHasAsyncOverload
        index.Synchronize<SimpleAction>(ChainFx.Chain.Store, CancellationToken.None);
        await index2.SynchronizeAsync<SimpleAction>(ChainFx.Chain.Store, CancellationToken.None);
